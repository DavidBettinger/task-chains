...
//    @Transactional
//    public TaskChainData saveAndUpdate(TaskChainData taskChainData) {
//        if (taskChainData == null) {
//            log.error("ChainTask is null. Are you sure you have connected your form to the application?");
//            return null;
//        }
...
//        TaskChain detachedTaskChain = taskChainDataConverter.convert(taskChainData);
//
//        TaskChain savedTaskChain = taskChainsRepository.save(detachedTaskChain);
//        log.debug("Saved taskChain with name: " + savedTaskChain.getName() + " and id: " + savedTaskChain.getId());
//        updateData(taskChainData, taskChainConverter.convert(savedTaskChain))
//        return taskChainData;
//    }
//
//    private void updateData(TaskChainData toUpdate, TaskChainData update) {
//        toUpdate.setCompleted(update.getCompleted());
//        toUpdate.setDescription(update.getDescription());
//        toUpdate.setName(update.getName());
//        toUpdate.setDeadline(update.getDeadline());
//        toUpdate.setCreatedAt(update.getCreatedAt());
//        // List<TaskData> taskDataList =
//        toUpdate.getTasks().forEach(taskData -> {
//            TaskData taskUpdate = getTaskWithTaskNumber(update.getTasks(), taskData.getTaskNumber());
//            updateTask(taskData, taskUpdate);
//        });
//    }
//
//    private void updateTask(TaskData taskToUpdate, TaskData update){
//        taskToUpdate.setCompleted(update.getCompleted());
//        taskToUpdate.setDescription(update.getDescription());
//        taskToUpdate.setName(update.getName());
//        taskToUpdate.setDeadline(update.getDeadline());
//        taskToUpdate.setCreatedAt(update.getCreatedAt());
//        taskToUpdate.setComment(update.getComment());
//        taskToUpdate.setTaskNumber(update.getTaskNumber());
//    }
//
//    private TaskData getTaskWithTaskNumber(List<TaskData> taskDataList, int number) {
//
//        for (TaskData taskData : taskDataList) {
//            if (taskData.getTaskNumber() == number) {
//                return taskData;
//            }
//        }
//        return null;
